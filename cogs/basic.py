...
class Basic(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed2.add_field(name="#mute", value="Заглушить участника")
        embed2.add_field(name="#unmute", value="Снять с участника мьют")
        embed2.add_field(name="#ban", value="Заблокировать участника")
        embed2.add_field(name="#kick", value="Изгнать участника")
        embed2.add_field(name="#warn", value="Выдать предупреждение участнику")
        embed2.add_field(name="#warnings", value="Показать список предупреждений")
        embed2.add_field(name="#delwarn", value="Снять предупреждение участника")
        embed2.add_field(name="#clear", value="Очистить сообщения")
        embed2.add_field(name="#note", value="Выдать заметку участнику")
        embed2.add_field(name="#delnote", value="Снять заметку участника")
        embed2.add_field(name="#notes", value="Показать список заметок")
        embed1.add_field(name="#avatar", value="Показать аватар участника")
        embed1.add_field(name="#servericon", value="Снять аватар сервера")
        embed1.add_field(name="#mes", value="Показать сообщения участника")
        embed1.add_field(name="#ping", value="Показать задержку бота")
        embed1.add_field(name="#shop", value="Показать список ролей в магазине")
        embed1.add_field(name="#buy-shop", value="Купить роль в магазине")
        embed3.add_field(name="#bal", value="Показать баланс пользователя")
        embed3.add_field(name="#daily", value="Получить ежедневную награду")
        embed3.add_field(name="#weekly", value="Получить еженедельную награду")
        embed3.add_field(name="#deposit", value="Пополнить банковский счёт")
        embed3.add_field(name="#withdraw", value="Снять деньги с банковского счёта")
        embed3.add_field(name="#pay", value="Передать деньги участнику")
        embed3.add_field(name="#roulette", value="Рулетка")
        embed3.add_field(name="#add-money", value="Выдать деньги участнику")
        embed3.add_field(name="#remove-money", value="Забрать деньги у участника")
        embed3.add_field(name="#add-messages", value="Выдать сообщение участнику")
        embed3.add_field(name="#remove-messages", value="Забрать сообщения у участника")
